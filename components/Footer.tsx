          ...
          <div>
            ...
            <div className="mt-4 flex gap-4">
              <a
                ...
                aria-label="Facebook"
                className="inline-flex h-11 w-11 items-center justify-center rounded-full text-foreground/60 transition-colors hover:bg-ecc-green-50 hover:text-ecc-green-700"
              >
